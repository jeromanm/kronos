...
create view relacion_rastro_informe as
...
from	rastro_informe
	...
	inner join condicion_eje_fun
            on condicion_eje_fun.numero_condicion_eje_fun = rastro_informe.numero_condicion_eje_fun
	left outer join usuario
            on usuario.id_usuario = rastro_informe.id_usuario
;
