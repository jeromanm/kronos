create or replace procedure elemento_segmento$adx(x$old elemento_segmento%ROWTYPE) is
...
begin
    ...
    select id_rol from rol_funcion where id_conjunto_segmento = x$old.id_conjunto_segmento));
end;
/
show errors
