create or replace function rastro_funcion$av1(x$new rastro_funcion%ROWTYPE)
return rastro_funcion%ROWTYPE is
    v$new rastro_funcion%ROWTYPE;
    cursor c$fdc is
        select
...
show errors
/*
create or replace function rastro_funcion$av2(x$new rastro_funcion%ROWTYPE, x$old rastro_funcion%ROWTYPE)
return rastro_funcion%ROWTYPE is
begin
    return x$new;
end;
