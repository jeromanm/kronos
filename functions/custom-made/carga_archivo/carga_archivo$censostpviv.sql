create or replace function carga_archivo$censostpviv(x$archivo VARCHAR2, x$clase_archivo VARCHAR2, x$sime number, observaciones nvarchar2) return number is
