create or replace function recla_pens$re_di_r_d$04469$biz(x$super number, x$reclamo number, x$observaciones nvarchar2) return number is
    ...
    v$estado              number;
begin
    begin --11.-revertir dictamen para reintegrar denegar:
      Select estado, tipo 
